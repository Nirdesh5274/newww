        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl font-bold text-[#1a1a2e] mb-6">
              Master Digital Marketing with Personalized Mentorship
            </h1>
            <p className="text-gray-600 text-lg mb-8 leading-relaxed">
              Digital Marketing builds brands online. Learn SEO, social media, and analytics to create impactful digital strategies.
            </p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-50 p-8 rounded-2xl border border-gray-200">
            ...
            <p className="text-gray-600 mb-4">
              Learn from top Digital Marketing professionals with comprehensive sessions covering all essential concepts and techniques.
            </p>
          ...
          <div className="bg-gray-50 p-8 rounded-2xl border border-gray-200">
            ...
            <p className="text-gray-600 mb-4">
              Get personalised guidance throughout your Digital Marketing journey with tailored feedback and mentoring.
            </p>
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <Check className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
          ...
          <div className="bg-gray-50 p-8 rounded-2xl border border-gray-200">
            ...
            <p className="text-gray-600 mb-4">
              Gain hands-on experience by working on real-world Digital Marketing projects with practical applications.
            </p>
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <Check className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-300 mb-8">
                Our curriculum is designed to take you from basics to advanced Digital Marketing concepts with practical applications in SEO, social media, content marketing, and analytics.
              </p>
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <Check className="h-6 w-6 text-[#e85a4f] mb-2" />
                  <div className="font-semibold">SEO & SEM</div>
                </div>
                <div>
                  <Check className="h-6 w-6 text-[#e85a4f] mb-2" />
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-center text-gray-600 mb-12">
            Invest in your Digital Marketing career with our comprehensive mentor-led program
          </p>
