  ...
  return (
    <main className="min-h-screen bg-white">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl font-bold text-[#1a1a2e] mb-6">
              Master Cyber Security with Personalized Mentorship
            </h1>
            <p className="text-gray-600 text-lg mb-8 leading-relaxed">
              This hands-on course is designed to equip you with the skills to protect systems and networks — from threat detection to security implementation that safeguards digital assets.
            </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="flex justify-center mt-12">
          <Button className="bg-[#FF6B4A] hover:bg-[#e85a4f] text-white px-10 py-4 text-base rounded-lg shadow-md font-semibold">
            Enroll Now & Start Your Cyber Security Journey
          </Button>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2 className="text-4xl font-bold mb-6">
                Comprehensive Cyber Security Curriculum
              </h2>
              <p className="text-gray-300 mb-8">
                Our curriculum is designed to take you from basics to advanced cyber security concepts with practical applications in network security, ethical hacking, and security operations.
              </p>
              <div className="grid grid-cols-2 gap-6">
                ...
                <div>
                  <Check className="h-6 w-6 text-[#e85a4f] mb-2" />
                  <div className="font-semibold">Ethical Hacking</div>
                </div>
                <div>
                  <Check className="h-6 w-6 text-[#e85a4f] mb-2" />
                ...
                <div>
                  <Check className="h-6 w-6 text-[#e85a4f] mb-2" />
                  <div className="font-semibold">Security Operations</div>
                </div>
              </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        <p className="text-center text-gray-500 text-sm mb-10">Everything you need to know about our Cyber Security Mentor-Led Course</p>
