...
const faqs = [
  {
    ...
    answer:
      "This course is perfect for beginners, aspiring mobile developers, and anyone interested in app development. Whether you want to build mobile apps or start a career as an app developer, this course will guide you.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "You'll work on 10+ live projects including mobile apps, cross-platform applications, iOS and Android apps, and real-world solutions that solve business challenges.",
  },
  {
    ...
    <main className="min-h-screen bg-white">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl font-bold text-[#1a1a2e] mb-6">
              Master App Development with Personalized Mentorship
            </h1>
            <p className="text-gray-600 text-lg mb-8 leading-relaxed">
              This hands-on course is designed to equip you with the skills to create powerful mobile applications — from iOS and Android apps to cross-platform solutions that solve real business challenges.
            </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-50 p-8 rounded-2xl border border-gray-200">
            ...
            <p className="text-gray-600 mb-4">
              Learn from top App Development professionals with comprehensive sessions covering all essential concepts and techniques.
            </p>
          ...
          <div className="bg-gray-50 p-8 rounded-2xl border border-gray-200">
            ...
            <p className="text-gray-600 mb-4">
              Get personalised guidance throughout your App Development journey with tailored feedback and mentoring.
            </p>
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <Check className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
          ...
          <div className="bg-gray-50 p-8 rounded-2xl border border-gray-200">
            ...
            <p className="text-gray-600 mb-4">
              Gain hands-on experience by working on real-world App Development projects with practical applications.
            </p>
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <Check className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
        ...
        <div className="flex justify-center mt-12">
          <Button className="bg-[#FF6B4A] hover:bg-[#e85a4f] text-white px-10 py-4 text-base rounded-lg shadow-md font-semibold">
            Enroll Now & Start Your App Development Journey
          </Button>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2 className="text-4xl font-bold mb-6">
                Comprehensive App Development Curriculum
              </h2>
              <p className="text-gray-300 mb-8">
                Our curriculum is designed to take you from basics to advanced mobile app concepts with practical applications in React Native, Flutter, iOS, and Android development.
              </p>
              <div className="grid grid-cols-2 gap-6">
                ...
                <div>
                  <Check className="h-6 w-6 text-[#e85a4f] mb-2" />
                  <div className="font-semibold">iOS Development</div>
                </div>
                <div>
                  <Check className="h-6 w-6 text-[#e85a4f] mb-2" />
                  <div className="font-semibold">Android Development</div>
                </div>
              </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center">
        <h2 className="text-4xl font-bold text-[#1a1a2e] mb-4">
          Ready to Transform Your App Development Career?
        </h2>
            ...
            {[
              {
                ...
                text: "Launched's App Development program helped me build amazing mobile apps. I now work as a mobile developer at a tech company."
              },
              {
                name: "Rohan S",
                role: "App Development Graduate",
                text: "This course taught me to create cross-platform applications. I now build mobile solutions for clients worldwide."
              },
              {
                name: "Prathap R",
                role: "App Development Graduate",
                text: "The mentorship and real-world projects gave me confidence to become a mobile app developer. The portfolio was a game-changer."
              },
              {
                name: "Ankita M",
                role: "App Development Graduate",
                text: "From React Native to Flutter, the program was very hands-on. I now work in mobile development at a global company."
              },
              {
                name: "Kunal V",
                role: "App Development Graduate",
                text: "We learned to build modern mobile applications for iOS and Android. I'm now creating mobile apps professionally."
              },
              {
                name: "Rohan S",
                role: "App Development Graduate",
                text: "This course taught me everything about app development. I now freelance and build mobile apps for businesses."
              }
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-center text-gray-600 mb-12">
            Invest in your App Development career with our comprehensive mentor-led program
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-400">Learn from top Web Development professionals at your own pace</div>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <Check className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-400">Build your portfolio with real-world web applications</div>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <Check className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-400">Connect with Web Development leaders and potential employers</div>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <Check className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
            ...
            <div className="bg-white rounded-3xl p-8 border-2 border-gray-200">
              <div className="flex justify-between items-start mb-6">
                <div>
                  <h3 className="text-2xl font-bold text-[#1a1a2e] mb-2">APP DEVELOPMENT</h3>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Learn from top Web Development professionals at your own pace</div>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <Check className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Build your portfolio with real-world web applications</div>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <Check className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Connect with Web Development leaders and potential employers</div>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <Check className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        <p className="text-center text-gray-500 text-sm mb-10">Everything you need to know about our App Development Mentor-Led Course</p>
