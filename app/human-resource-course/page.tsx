...
export default function HumanResourceCoursePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-orange-50 px-4 py-2 rounded-full mb-6">
            <span className="text-orange-600 font-semibold">🎓 Human Resource Design</span>
          </div>
          <h1 className="text-4xl md:text-6xl font-bold text-[#1a1a2e] mb-6">
            Master Human Resource Design with
            <br />
            <span className="text-[#e85a4f]">Industry Experts</span>
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            Very Large Scale Integration (Human Resource) focuses on chip design for electronics. Master circuit design techniques
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto mb-12">
            ...
            <div className="bg-gradient-to-br from-[#e85a4f] to-[#d64940] rounded-2xl p-8 text-white">
              ...
              <h3 className="text-2xl font-bold mb-4">Human Resource Mentor-Led Course</h3>
            ...
            <div className="bg-white border-2 border-gray-200 rounded-2xl p-8">
              ...
              <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Human Resource Blended Course</h3>
          ...
          <div className="grid md:grid-cols-2">
            <div className="p-12">
              ...
              <p className="text-gray-300 mb-8">
                Get a preview of our comprehensive Human Resource curriculum designed by semiconductor industry leaders
              </p>
      ...
      {/* Course Features */}
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <h2 className="text-3xl font-bold text-center text-[#1a1a2e] mb-12">Why Choose Our Human Resource Course?</h2>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            ...
            },
            {
              ...
              description:
                "Cover digital design, analog circuits, and advanced verification techniques for modern Human Resource",
            },
            {
              icon: Award,
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#1a1a2e]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              {
                title: "Digital Human Resource Design",
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="bg-gradient-to-r from-[#e85a4f] to-[#d64940] rounded-3xl p-12 text-center text-white">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Master Human Resource Design?</h2>
          ...
          <button className="bg-white text-[#e85a4f] px-8 py-4 rounded-xl font-semibold text-lg hover:bg-gray-100 transition-colors">
            Enroll in Human Resource Course Today
          </button>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            {
              name: "Priya Sharma",
              role: "Human Resource Engineer at Intel",
              content:
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        <p className="text-center text-gray-500 text-sm mb-10">Everything you need to know about our Human Resource Mentor-Led Course</p>
        <div className="space-y-4">
          {[
            {
              q: "What prerequisites do I need for this Human Resource course?",
