...
const faqs = [
  {
    ...
    answer:
      "This course is perfect for beginners, data enthusiasts, and anyone interested in machine learning. Whether you want to build ML models or start a career as a data scientist, this course will guide you.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "You'll work on 10+ live projects including predictive models, classification systems, neural networks, and real-world ML applications that solve business challenges.",
  },
  {
    ...
    <main className="min-h-screen bg-white">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl font-bold text-[#1a1a2e] mb-6">
              Master Machine Learning with Personalized Mentorship
            </h1>
            <p className="text-gray-600 text-lg mb-8 leading-relaxed">
              This hands-on course is designed to equip you with the skills to create powerful ML models — from data analysis to predictive systems that solve real business challenges.
            </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-50 p-8 rounded-2xl border border-gray-200">
            ...
            <p className="text-gray-600 mb-4">
              Learn from top Machine Learning professionals with comprehensive sessions covering all essential concepts and techniques.
            </p>
          ...
          <div className="bg-gray-50 p-8 rounded-2xl border border-gray-200">
            ...
            <p className="text-gray-600 mb-4">
              Get personalised guidance throughout your Machine Learning journey with tailored feedback and mentoring.
            </p>
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <Check className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
          ...
          <div className="bg-gray-50 p-8 rounded-2xl border border-gray-200">
            ...
            <p className="text-gray-600 mb-4">
              Gain hands-on experience by working on real-world Machine Learning projects with practical applications.
            </p>
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <Check className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
        ...
        <div className="flex justify-center mt-12">
          <Button className="bg-[#FF6B4A] hover:bg-[#e85a4f] text-white px-10 py-4 text-base rounded-lg shadow-md font-semibold">
            Enroll Now & Start Your Machine Learning Journey
          </Button>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-300 mb-8">
                Our curriculum is designed to take you from basics to advanced ML concepts with practical applications in Python, data analysis, neural networks, and more.
              </p>
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <Check className="h-6 w-6 text-[#e85a4f] mb-2" />
                  <div className="font-semibold">Python & Data Science</div>
                </div>
                <div>
                  <Check className="h-6 w-6 text-[#e85a4f] mb-2" />
                  <div className="font-semibold">Supervised Learning</div>
                </div>
                <div>
                  <Check className="h-6 w-6 text-[#e85a4f] mb-2" />
                ...
                <div>
                  <Check className="h-6 w-6 text-[#e85a4f] mb-2" />
                  <div className="font-semibold">Model Deployment</div>
                </div>
              </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center">
        <h2 className="text-4xl font-bold text-[#1a1a2e] mb-4">
          Ready to Transform Your Machine Learning Career?
        </h2>
            ...
            {[
              {
                ...
                text: "Launched's Machine Learning program helped me build predictive models. I now work as an ML engineer at a tech company."
              },
              {
                name: "Rohan S",
                role: "Machine Learning Graduate",
                text: "This course taught me to create ML algorithms. I now build data-driven solutions for clients worldwide."
              },
              {
                name: "Prathap R",
                role: "Machine Learning Graduate",
                text: "The mentorship and real-world projects gave me confidence to become an ML specialist. The portfolio was a game-changer."
              },
              {
                name: "Ankita M",
                role: "Machine Learning Graduate",
                text: "From Python to deep learning, the program was very hands-on. I now work in ML at a global company."
              },
              {
                name: "Kunal V",
                role: "Machine Learning Graduate",
                text: "We learned to build neural networks and deploy ML models. I'm now creating ML solutions professionally."
              },
              {
                name: "Rohan S",
                role: "Machine Learning Graduate",
                text: "This course taught me everything about machine learning. I now work on AI/ML projects for businesses."
              }
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-center text-gray-600 mb-12">
            Invest in your Machine Learning career with our comprehensive mentor-led program
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-3xl p-8 border-2 border-gray-200">
              <div className="flex justify-between items-start mb-6">
                <div>
                  <h3 className="text-2xl font-bold text-[#1a1a2e] mb-2">MACHINE LEARNING</h3>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        <p className="text-center text-gray-500 text-sm mb-10">Everything you need to know about our Machine Learning Mentor-Led Course</p>
