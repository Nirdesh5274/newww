...
const faqs = [
  {
    ...
    answer:
      "This course is perfect for beginners, aspiring developers, and anyone interested in web development. Whether you want to build websites or start a career as a web developer, this course will guide you.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "You'll work on 10+ live projects including responsive websites, web applications, e-commerce sites, and real-world applications that solve business challenges.",
  },
  {
    ...
    <main className="min-h-screen bg-white">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl font-bold text-[#1a1a2e] mb-6">
              Master Web Development with Personalized Mentorship
            </h1>
            <p className="text-gray-600 text-lg mb-8 leading-relaxed">
              This hands-on course is designed to equip you with the skills to create powerful web applications — from responsive websites to dynamic web platforms that solve real business challenges.
            </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-50 p-8 rounded-2xl border border-gray-200">
            ...
            <p className="text-gray-600 mb-4">
              Learn from top Web Development professionals with comprehensive sessions covering all essential concepts and techniques.
            </p>
          ...
          <div className="bg-gray-50 p-8 rounded-2xl border border-gray-200">
            ...
            <p className="text-gray-600 mb-4">
              Get personalised guidance throughout your Web Development journey with tailored feedback and mentoring.
            </p>
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <Check className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
          ...
          <div className="bg-gray-50 p-8 rounded-2xl border border-gray-200">
            ...
            <p className="text-gray-600 mb-4">
              Gain hands-on experience by working on real-world Web Development projects with practical applications.
            </p>
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <Check className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
        ...
        <div className="flex justify-center mt-12">
          <Button className="bg-[#FF6B4A] hover:bg-[#e85a4f] text-white px-10 py-4 text-base rounded-lg shadow-md font-semibold">
            Enroll Now & Start Your Web Development Journey
          </Button>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-300 mb-8">
                Our curriculum is designed to take you from basics to advanced web concepts with practical applications in HTML, CSS, JavaScript, React, and more.
              </p>
              <div className="grid grid-cols-2 gap-6">
                ...
                <div>
                  <Check className="h-6 w-6 text-[#e85a4f] mb-2" />
                  <div className="font-semibold">Backend Development</div>
                </div>
              </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center">
        <h2 className="text-4xl font-bold text-[#1a1a2e] mb-4">
          Ready to Transform Your Web Development Career?
        </h2>
              ...
              {[
                {
                  ...
                  text: "Launched's Web Development program helped me build amazing websites. I now work as a frontend developer at a tech company."
                },
                {
                  name: "Rohan S",
                  role: "Web Development Graduate",
                  text: "This course taught me to create responsive web applications. I now build web solutions for clients worldwide."
                },
                {
                  name: "Prathap R",
                  role: "Web Development Graduate",
                  text: "The mentorship and real-world projects gave me confidence to become a full-stack developer. The portfolio was a game-changer."
                },
                {
                  name: "Ankita M",
                  role: "Web Development Graduate",
                  text: "From HTML to React, the program was very hands-on. I now work in web development at a global company."
                },
                {
                  name: "Kunal V",
                  role: "Web Development Graduate",
                  text: "We learned to build modern web applications using React and Next.js. I'm now creating web platforms professionally."
                },
                {
                  name: "Rohan S",
                  role: "Web Development Graduate",
                  text: "This course taught me everything about web development. I now freelance and build websites for businesses."
                },
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-center text-gray-600 mb-12">
            Invest in your Web Development career with our comprehensive mentor-led program
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-3xl p-8 border-2 border-gray-200">
              <div className="flex justify-between items-start mb-6">
                <div>
                  <h3 className="text-2xl font-bold text-[#1a1a2e] mb-2">WEB DEVELOPMENT</h3>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        <p className="text-center text-gray-500 text-sm mb-10">Everything you need to know about our Web Development Mentor-Led Course</p>
