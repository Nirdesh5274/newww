...
export default function IoTRoboticsCoursePage() {
    ...
    <main className="min-h-screen bg-white">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl font-bold text-[#1a1a2e] mb-6">
              Master IoT & Robotics with Personalized Mentorship
            </h1>
            <p className="text-gray-600 text-lg mb-8 leading-relaxed">
              Explore the intersection of IoT and Robotics—develop smart, connected devices to automate tasks and build intelligent systems.
            </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-50 p-8 rounded-2xl border border-gray-200">
            ...
            <p className="text-gray-600 mb-4">
              Learn from top IoT & Robotics professionals with comprehensive sessions covering all essential concepts and techniques.
            </p>
          ...
          <div className="bg-gray-50 p-8 rounded-2xl border border-gray-200">
            ...
            <p className="text-gray-600 mb-4">
              Get personalised guidance throughout your IoT & Robotics journey with tailored feedback and mentoring.
            </p>
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <Check className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
          ...
          <div className="bg-gray-50 p-8 rounded-2xl border border-gray-200">
            ...
            <p className="text-gray-600 mb-4">
              Gain hands-on experience by working on real-world IoT & Robotics projects with practical applications.
            </p>
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <Check className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
        ...
        <div className="flex justify-center mt-12">
          <Button className="bg-[#FF6B4A] hover:bg-[#e85a4f] text-white px-10 py-4 text-base rounded-lg shadow-md font-semibold">
            Enroll Now & Start Your IoT Robotics Journey
          </Button>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2 className="text-4xl font-bold mb-6">
                Comprehensive IoT & Robotics Curriculum
              </h2>
              <p className="text-gray-300 mb-8">
                Our curriculum is designed to take you from basics to advanced IoT & Robotics concepts with practical applications in embedded systems, sensor networks, and automation.
              </p>
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <Check className="h-6 w-6 text-[#e85a4f] mb-2" />
                  <div className="font-semibold">IoT Fundamentals</div>
                </div>
                <div>
                  <Check className="h-6 w-6 text-[#e85a4f] mb-2" />
                  <div className="font-semibold">Robotics Design</div>
                </div>
                <div>
                  <Check className="h-6 w-6 text-[#e85a4f] mb-2" />
                  <div className="font-semibold">Sensor Networks</div>
                </div>
                <div>
                  <Check className="h-6 w-6 text-[#e85a4f] mb-2" />
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center">
        <h2 className="text-4xl font-bold text-[#1a1a2e] mb-4">
          Ready to Transform Your IoT & Robotics Career?
        </h2>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-center text-gray-600 mb-12">
            Invest in your IoT & Robotics career with our comprehensive mentor-led program
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-black text-white rounded-3xl p-8 border-4 border-[#e85a4f]">
              <div className="flex justify-between items-start mb-6">
                <div>
                  <h3 className="text-2xl font-bold mb-2">IOT & ROBOTICS</h3>
            ...
            <div className="bg-white rounded-3xl p-8 border-2 border-gray-200">
              <div className="flex justify-between items-start mb-6">
                <div>
                  <h3 className="text-2xl font-bold text-[#1a1a2e] mb-2">IOT & ROBOTICS</h3>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        <p className="text-center text-gray-500 text-sm mb-10">Everything you need to know about our IoT & Robotics Mentor-Led Course</p>
